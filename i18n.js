...
window.I18N = {
  ko: {
    ...
    /* home */
    "home.intro.name": "박용욱",
    "home.intro.eyebrow": "KAIST SAIL · LLM internals · tool-using agents",
    "home.intro.role": "LLM 내부를 읽고, 작게 만들어 검증합니다",
    "home.intro.bio": "KAIST SAIL에서 LLM이 답을 만드는 과정을 들여다봅니다. attention head와 circuit 수준의 가설을 세우고, knowledge editing이나 작은 도구 실험으로 실제로 맞는지 확인하는 연구를 합니다.",
    "home.avatar.kicker": "현재 질문",
    "home.avatar.title": "모델은 어떻게 답에 도착할까?",
    "home.avatar.note": "해석가능성 노트, 에이전트 구현, 작게 쪼개 검증하는 실험을 모아 둔 포트폴리오입니다.",
    ...
    "home.interests.heading": "요즘 붙잡고 있는 질문",
    ...
    "cv.awards.1.period": "TBD",
    "cv.awards.1.title": "TBD",
    "cv.awards.1.desc": "TBD",
    "cv.awards.2.period": "TBD",
    "cv.awards.2.title": "TBD",
    "cv.awards.2.desc": "TBD",
    "cv.certs.heading": "자격 · 기타",
    "cv.certs.1.period": "TBD",
    "cv.certs.1.title": "TBD",
    "cv.certs.1.desc": "TBD",
  ...
  en: {
    ...
    "home.intro.eyebrow": "KAIST SAIL · LLM internals · tool-using agents",
    "home.intro.role": "Reading LLM internals, then testing the idea in small builds",
    "home.intro.bio": "At KAIST SAIL, I study how LLMs arrive at answers. I form hypotheses at the attention-head and circuit level, then test them through knowledge editing and compact tool-building experiments.",
    "home.avatar.kicker": "current thread",
    "home.avatar.title": "How does a model arrive at an answer?",
    "home.avatar.note": "A portfolio for interpretability notes, agent-building projects, and experiments that are small enough to inspect.",
    "home.avatar.metric1.value": "SAIL",
    "home.avatar.metric1.label": "KAIST",
    "home.avatar.metric2.value": "MCP",
    "home.avatar.metric2.label": "agents",
